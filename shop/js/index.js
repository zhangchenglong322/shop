...
$(function() {
    ...
    $(".h_prev").click(function() {
        var left = document.querySelector(".featureUL").offsetLeft;
        console.log(left);
        left -= 975;
        console.log(left);
        $(".featureUL").animate({
            ...
            document.querySelector(".featureUL").style.left = (left == -1950 ? 0 : left) + "px";
        })
        return false;
    })
    ...
    $(".h_next").click(function() {
        var left = document.querySelector(".featureUL").offsetLeft;
        document.querySelector(".featureUL").style.left = (left == 0 ? -1950 : left) + "px";
        left = document.querySelector(".featureUL").offsetLeft;
        left += 975;
        console.log(left);
        $(".featureUL").animate({
            left: left + "px"
